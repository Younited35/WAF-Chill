...
<body>
    ...
    <div class="wrapper">
        ...
        echo "<section class='movie-detail-intro overlay-gradient ptb100' style='background: url(".$tmdb->getImageURL('w1280').$tvShow->getBackdrop().");'>";
            ...
            <div class="container">
                ...
                <div class="movie-details">
                  <?php
                    ...
                    echo "<h1 class='title'>".$tvShow->getName()."</h1>";

                  ?>

                    <ul class="movie-subtext"><br>
                      <?php
                        $s ="s";
